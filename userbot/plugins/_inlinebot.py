...
def button(page, modules):
    ...
    # Changing this line may give error in bot as i added some special cmds in Elitebot channel to get this module work...
...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == bot.uid and query == "@HellBot_Official":
            ...
            result = builder.article(
                "@ELITES_SUPPORT",
                text="""**Hey! This is [ELITEẞø†.](https://t.me/ELITES_SUPPORT) \nYou can know more about me from the links given below 👇**""",
                buttons=[
                    [
                        custom.Button.url("🔥 CHANNEL 🔥", "https://t.me/ELITES_SUPPORT"),
                        custom.Button.url("⚡ GROUP ⚡", "https://t.me/ELITES_SUPPORT"),
                    ],
                    [
                        custom.Button.url(
                            "✨ REPO ✨", "https://github.com/Elite-Userbot/ELITEUSERBOT"
                        ),
                        custom.Button.url("🔰 TUTORIAL 🔰", "UPLOADING SOON"),
                    ],
                ],
                link_preview=False,
            )
    ...
    async def page(event):
        ...
        await event.edit(
            f"**Legenday AF** [Eliteẞøt](https://t.me/ELITES_SUPPORT) __Working...__\n\n**Number of modules installed :** `{len(CMD_HELP)}`\n**page:** {page + 1}/{veriler[0]}",
            buttons=veriler[1],
            link_preview=False,
        )
